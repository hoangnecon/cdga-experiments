"""
Component: Vaihingen Dataset Loader
Location: shared/datasets/vaihingen.py
...
class VaihingenDataset(Dataset):
    """Dataset class for ISPRS Vaihingen segmentation dataset (pre-cropped 512x512 PNGs)."""

    def __init__(self, split: str, crop_size: Optional[int] = None, data_root: str = "data/vaihingen") -> None:
        self.split = split
