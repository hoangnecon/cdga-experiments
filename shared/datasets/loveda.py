"""
Component: LoveDA Dataset Loader
Location: shared/datasets/loveda.py
...
class LoveDADataset(Dataset):
    """Dataset class for LoveDA Urban/Rural segmentation dataset (pre-cropped 512x512 PNGs)."""

    def __init__(self, split: str, crop_size: Optional[int] = None, data_root: str = "data/loveda_uda/urban") -> None:
        self.split = split
        self.data_root = data_root
        self.crop_size = crop_size

        # Layout on local SSD / Google Drive after extraction
        # Example: data/loveda_uda/urban/train/img_dir/
        self.img_dir = osp.join(data_root, split, "img_dir")
        self.mask_dir = osp.join(data_root, split, "ann_dir")
